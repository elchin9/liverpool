...
namespace Liverpool.Migrations
{
    ...
    [Migration("20191105113052_CreateDb")]
            ...
            modelBuilder.Entity("Liverpool.Models.CupType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 3, Name = "FA Kuboku" },
                        new { Id = 4, Name = "Avropa Liqası" },
                        new { Id = 5, Name = "UEFA Super Kuboku" },
                        new { Id = 6, Name = "Ölkə Kuboku" },
            ...
            modelBuilder.Entity("Liverpool.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Clock = "19:00", Map = "<iframe src='https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d24315.23772871157!2d49.85388954714356!3d40.37772197528239!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xd8897cf79ec36111!2s28%20Mall!5e0!3m2!1str!2s!4v1572944839076!5m2!1str!2s' width='600' height='450' frameborder='0' style='border:0;' allowfullscreen=''></iframe>", Phone = "051 555 55 55", Place = "28 Mall", Time = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Title = "Liverpool - Manchester City" }
                    );
                });
            ...
            modelBuilder.Entity("Liverpool.Models.Slider", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, PhotoURL = "slider/liverpool1.jpg" },
            ...
            modelBuilder.Entity("Liverpool.Models.VideoCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 7, Name = "Community Shield" },
                        new { Id = 8, Name = "FIFA Klublararası DÇ" },
